...
class SignedWebBox extends React.Component {
    constructor(props){
       super(props); 
       this.state={
        added:false
...
onclick1 = ()=>{
    ...
    return     <div class="web_box">
        <img class="web_img" src={this.props.image} />
        <p class='web_details'>&nbsp;&nbsp;&nbsp;&nbsp;
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b style={{ position: "relative", bottom: "23px", right: "18px", fontSize: "22px" }}>{this.props.name}</b> <br /><br />
